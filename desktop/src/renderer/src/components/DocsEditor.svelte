...
<div class="flex h-full min-h-0 flex-col">
  <div class="flex items-center gap-1 border-b border-line px-5 py-1.5">
  ...
  {#if mode === 'edit'}
    <textarea
      ...
      {placeholder}
      spellcheck="true"
      class="min-h-0 flex-auto resize-none bg-transparent px-5 py-3 font-mono text-sm outline-none"
    ></textarea>
  {:else}
    <div data-role="docs-preview" class="markdown min-h-0 flex-auto overflow-auto px-5 py-3 text-sm">
      {#if html}
